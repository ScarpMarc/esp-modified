...
// In/out arrays
#define SIZE_IN_CHUNK_DATA N_RANGE_UPSAMPLED * 2 + 3 // N_RANGE_UPSAMPLED*2 (complex radar readings) + 3 (emitter position as x y z)

#define SIZE_OUT_CHUNK_DATA (BP_NPIX_X * BP_NPIX_Y * 2) // (complex-valued image of size BP_NPIX_X by BP_NPIX_Y)
