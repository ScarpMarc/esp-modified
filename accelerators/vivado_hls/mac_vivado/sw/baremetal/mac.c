...
int main(int argc, char * argv[])
{
	...
	if (DMA_WORD_PER_BEAT(sizeof(token_t)) == 0) {
		...
		in_words_adj = round_up(6400, DMA_WORD_PER_BEAT(sizeof(token_t)));
		out_words_adj = round_up(100, DMA_WORD_PER_BEAT(sizeof(token_t)));
	}
	in_len = in_words_adj * (16);
	out_len = out_words_adj * (16);
